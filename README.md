...
`browser.waitForElementNotExist(cssSelector, timeout=3000)` | Waits for the element at `cssSelector` to be removed, then returns `null`. Times out after `timeout` ms.
